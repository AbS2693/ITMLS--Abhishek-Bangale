...
def create_pattern_observations():
    ...
    print("   - Represent highway/open road with minimal objects")
    ...
    print("   - Typically appear at intersections/road junctions")
    ...
    print(f"   - MINORITY class: {len(pedestrian)/len(labels_df)*100:.1f}% of data")
    ...
    print("   - MAJORITY class: vehicles are frequent in urban driving")
    ...
    print("   - Complex scenarios with all elements present")
    
    print("\n" + "=" * 80)
    print("TRAINING IMPLICATIONS:")
    print("=" * 80)
    print("""
- CLASS IMBALANCE: Pedestrian detection is severely imbalanced (~24% positive)
- SAFETY: False negatives are more dangerous than false positives
- METRICS: Use Precision/Recall/F1 rather than accuracy alone
    """)
